...
# LABEL org.opencontainers.image.documentation="https://gitlab.syncad.com/pixagram/pixagram"
# LABEL org.opencontainers.image.source="https://gitlab.syncad.com/pixagram/pixagram"
#LABEL org.opencontainers.image.version="${VERSION}"
LABEL org.opencontainers.image.revision="$GIT_COMMIT_SHA"
LABEL org.opencontainers.image.licenses="MIT"
LABEL org.opencontainers.image.ref.name="Pixagram Daemon"
LABEL org.opencontainers.image.title="Pixagram Daemon (pixad) Image"
LABEL org.opencontainers.image.description="Runs pixad instance. Contains various tools (including cli_wallet)"
LABEL io.pixagram.image.branch="$GIT_CURRENT_BRANCH"
LABEL io.pixagram.image.commit.log_message="$GIT_LAST_LOG_MESSAGE"
LABEL io.pixagram.image.commit.author="$GIT_LAST_COMMITTER"
LABEL io.pixagram.image.commit.date="$GIT_LAST_COMMIT_DATE"
