...
#define HIVE_HBD_START_PERCENT                (20*HIVE_1_PERCENT) // Start reducing printing of HBD at 20% Market Cap
#define HIVE_HBD_STOP_PERCENT                 (20*HIVE_1_PERCENT) // Stop printing HBD at 20% Market Cap
#define HIVE_HBD_HARD_LIMIT                   (10*HIVE_1_PERCENT) // Artificial HBD price kicks in at 10% Market Cap
