...
DEFINE_API_ARGS( list_proposal_votes,                    vector< variant >,   hive::protocol::serializer_wrapper< vector< database_api::api_proposal_vote_object > > )
DEFINE_API_ARGS( find_recurrent_transfers,               vector< variant >,   hive::protocol::serializer_wrapper< vector< database_api::api_recurrent_transfer_object > > )
